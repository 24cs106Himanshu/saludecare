...
// ─── BASE CONFIGURATION ──────────────────────────────────────────────────
// Use the production backend for all normal database features (so login and appointments work!)
const api = axios.create({
    baseURL: import.meta.env.VITE_API_URL || 'https://saludecare.onrender.com/api',
